...
acf_add_local_field_group( array(
	...
	'fields' => array (
        ...
        array (
			'key' => $prefix_key.'enable_background',
			'name' => 'enable_background',
			'label' => esc_html__('Enable Background', 'epcl_framework'),
			'instructions' => esc_html__('Enable/Disable background for this page.', 'epcl_framework'),
			'type' => 'true_false',
			'default_value' => true,
			'ui' => true,
		),
		array (
			...
			'instructions' => esc_html__('Enable/Disable sidebar for this page.', 'epcl_framework'),
			'type' => 'true_false',
			'default_value' => true,
			'ui' => true,
		),
		array (
			...
			'instructions' => esc_html__('Use a different sidebar for this page.', 'epcl_framework'),
			'type' => 'select',
