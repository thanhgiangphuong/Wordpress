...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			...
			'type' => 'text',
			'sanitize' => 'sanitize_url',
			'title' => '<i class="fa-stack fa-lg"><i class="fa fa-square-o fa-stack-2x"></i><i class="fa fa-paragraph fa-stack-1x fa-flip-horizontal"></i></i> '.esc_html__('Patreon url', 'epcl_framework'),
			'desc' => esc_html__('e.g. https://www.patreon.com/username', 'epcl_framework')
        ),
		array(
			'id' => 'rss_url',
			'type' => 'text',
