...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			'id' => 'siblings_posts_category',
			'type' => 'switcher',
			'title' => esc_html__('Same Category next/prev posts', 'epcl_framework'),
			'desc' => esc_html__('Display siblings post in the same category', 'epcl_framework'),
			'default' => 0
		),
	)
) );
