...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(
			...
			'desc' => __('Leave blank to use the default page sidebar.<br>You can add a new custom sidebar at the top of this page, then click save to see it here.<br><b>Important:</b> do not attach Footer sidebar here, it is recommended to use page sidebar or custom sidebars.', 'epcl_framework'),
            'options' => 'sidebars',
